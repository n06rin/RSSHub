...
// tcm10
router.get('/tcm10/news', require('./routes/tcm10'));

// sibkray.ru
router.get('/sibkray/news', require('./routes/sibkray'));

// sib.fm
router.get('/sibfm/all', require('./routes/sibfm'));

// precedent.tv
router.get('/precedent', require('./routes/precedent'));
